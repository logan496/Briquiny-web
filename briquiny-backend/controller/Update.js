...
class Update{
    async static UpdateTransportPrice(req, res){
    ...
    async static UpdatePrice(req, res){
    ...
    async static UpdatePriceInscription(req,res){
    ...
    async static UpdateZones(req, res){
        const {zone} = req.body
    ...
    async static UpdateCycle(req, res){
    ...
    async static UpdateDate(req, res){
        const {date} = req.body
